...
def app():
    ...
    height = st.number_input("Height", min_value=0.0, max_value=None, value=21.5,step=0.1)
    width = st.number_input("Width", min_value=0.0, max_value=None, value=8.5,step=0.1)
    weight = st.number_input("Weight", min_value=0.0, max_value=None, value = 3210.5,step=0.1)
    material = st.selectbox("Material", ["Wood", "Brass", "Aluminium", "Bronze", "Stone","Clay", "Marble"])
    base_price = st.number_input("Base Price", min_value=0.0, max_value=None, value=30.5,step=0.1)
    price = st.number_input("Price", min_value=0.0, max_value=None, value=15.5,step=0.1)
